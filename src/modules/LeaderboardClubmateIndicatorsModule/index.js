...
class LeaderboardClubmateIndicatorsModule extends CoreModule {
    ...
    shouldRun () {
        return ['activities', 'leagues.html', 'pantheon', 'season.html', 'path-of-valor', 'path-of-glory', 'seasonal'].some(page => Helpers.isCurrentPage(page))
    }
    ...
    async addClubmateAnnotations (data) {
        ...
        const isLeagues = Helpers.isCurrentPage('leagues.html')
